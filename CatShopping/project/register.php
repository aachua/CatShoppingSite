	...
	<header>
		<div class="navbar">
			<ul id="list-nav">
				...
				{
					echo "<li style='float:right'><a href='register.php' class='active'>Login/Register</a></li>";
				}
				?>
			</ul>
		</div>
	  ...
	  <div class="forms">
		<section class="login">
			...
			<form method="post" action="login.php">
				...
				Password: <input type = "password" name="pass" style="margin-left:6%"></br>
				<input type="submit" value="Login" name="submit">
			</form>
		</section>
		<section class="register">
			<h1>Register</h1>
			<p>Sign up below for a free account!</p>
